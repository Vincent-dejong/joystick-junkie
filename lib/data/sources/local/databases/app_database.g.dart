    ...
    final databaseOptions = sqflite.OpenDatabaseOptions(
      ...
      onCreate: (database, version) async {
        await database.execute(
            'CREATE TABLE IF NOT EXISTS `games` (`id` INTEGER NOT NULL, `name` TEXT NOT NULL, `coverImageUrl` TEXT, `description` TEXT, `rating` REAL, PRIMARY KEY (`id`))');
...
class _$GameDao extends GameDao {
  ...
  Future<void> insertGames(List<GameEntity> games) async {
    await _gameEntityInsertionAdapter.insertList(games, OnConflictStrategy.replace);
  }
}
